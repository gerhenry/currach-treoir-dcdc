* TR100 CONTROL V4 (PROPER STARTUP)

VDD vdd 0 1.8
VEN enable 0 PULSE(0 1.8 100n 1n 1n 10u 20u)
...
* MASTER BIAS (gated)
**************************************************
BSSBIAS ibias_ss 0 I = { (V(enable)>0.9) ? IMASTER*ISSCALE_SS : 0 }
BRAMPBIAS ibias_ramp 0 I = { (V(enable)>0.9) ? IMASTER*ISSCALE_RAMP : 0 }
...
wrdata ~/tmp/tr100_ctrl_bias_ss_pwm_v4.dat v(enable) v(ss) v(vref_ss) v(ramp) v(pwm)
